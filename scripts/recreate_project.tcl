...
#
# recreate_project.tcl: Tcl script for re-creating project 'shared_vc_1223'
#
# Generated by Vivado on Sun Dec 28 15:12:36 CST 2025
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
   "${origin_dir}/src/hdl/downstream_switch_model_v2.v" \
   "${origin_dir}/src/hdl/fcp_sink_adapter.v" \
   ...
   "${origin_dir}/src/ip/ila_1/ila_1.xci" \
   "${origin_dir}/src/ip/ila_0/ila_0.xci" \
   "${origin_dir}/sim/tb_downstream_switch_model_bram.sv"
  ]
  foreach ifile $files {
  ...
  set files [list \
   "${origin_dir}/src/hdl/axis_fifo.v" \
   "${origin_dir}/src/hdl/massive_traffic_injector.v" \
   "${origin_dir}/src/hdl/pkt_send_simulator.v" \
   ...
   "${origin_dir}/sim/tb_tx_scheduler_rr.sv" \
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set _xil_proj_name_ "Infiniflow"
...
# Create project
create_project ${_xil_proj_name_} ./work -force -part xcu280-fsvh2892-2L-e
...
set files [list \
 [file normalize "${origin_dir}/src/hdl/axis_fifo.v"] \
 [file normalize "${origin_dir}/src/hdl/massive_traffic_injector.v"] \
...
set files [list \
 [file normalize "${origin_dir}/src/hdl/downstream_switch_model_v2.v" ]\
 [file normalize "${origin_dir}/src/hdl/fcp_sink_adapter.v" ]\
...
set obj [get_filesets sources_1]
set_property -name "top" -value "bsfc_system_top" -objects $obj
...
# Add local files from the original project (-no_copy_sources specified)
set files [list \
 [file normalize "${origin_dir}/src/ip/cmac_usplus_0/cmac_usplus_0.xci" ]\
]
set added_files [add_files -fileset sources_1 $files]
...
# Set 'sources_1' fileset file properties for local files
set file "${origin_dir}/src/ip/cmac_usplus_0/cmac_usplus_0.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
# Add local files from the original project (-no_copy_sources specified)
set files [list \
 [file normalize "${origin_dir}/src/ip/cmac_usplus_1/cmac_usplus_1.xci" ]\
]
set added_files [add_files -fileset sources_1 $files]
...
# Set 'sources_1' fileset file properties for local files
set file "${origin_dir}/src/ip/cmac_usplus_1/cmac_usplus_1.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
set file "[file normalize ${origin_dir}/constr/co.xdc]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constr/co.xdc"
...
set files [list \
 [file normalize "${origin_dir}/sim/tb_system_top.sv"] \
 [file normalize "${origin_dir}/sim/tb_massive_traffic_injector.sv"] \
 [file normalize "${origin_dir}/sim/tb_tx_scheduler_rr.sv"] \
]
add_files -norecurse -fileset $obj $files

# Add local files from the original project (-no_copy_sources specified)
set files [list \
 [file normalize "${origin_dir}/sim/tb_downstream_switch_model_bram.sv" ]
]
set added_files [add_files -fileset sim_1 $files]

# Set 'sim_1' fileset file properties for remote files
set file "$origin_dir/sim/tb_system_top.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/sim/tb_massive_traffic_injector.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/sim/tb_tx_scheduler_rr.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set_property -name "top" -value "tb_system_top" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
